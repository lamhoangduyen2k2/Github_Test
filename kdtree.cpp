...
void input_colour_name(Colour_code_name input[], int n, string infile)
{
 ...
 //
 kd_node_t* findMinRec(kd_node_t* root, int d)
 {
     // Base cases
     if (root == NULL)
         return NULL;
 ...
 int main(void)
 {
     ...
     struct kd_node_t mang3[] = {
         {{2,3,7}}, {{4,3,4}}, {{3, 1, 4}}, {{2,1,3}}, {{2,4,5}}, {{6,1,4}}, {{1,4,4}},{{0,5,7}},{{5,2,5}},{{4,0,6}},{{7,1,6}}, {{4,5,9}}, {{7,4,7}}, {{1,0,7}}, {{4,3,9}} /*{{1,4,7}}, {{2,6,3}}, {{0,7,3}}, {{6,3,9}}, {{6,1,0}}, {{3,4,7}}, {{9,8,3}}, {{7,3,3}}, {{4,2,0}}, {{6,7,1}}, {{3,0,1}}, {{4,2,2}}*/
     };
     struct kd_node_t testNode2 = { {6, 1, 4} };
     root2 = make_tree(mang3, sizeof(mang3) / sizeof(mang3[1]), 0, 3);

     root2 = deleteNode(root2, (&testNode2));
     //
     testNode2 = { {4, 0, 6} };
     root2 = deleteNode(root2, (&testNode2));
     //
